...
public record JiraIssueResponseDto(string Key, string Summary, string Status, string Priority, string Url, string? Assignee, DateTime? Created, DateTime? Updated, string? Description, string? IssueType = null, List<JiraCommentResponseDto>? Comments = null, string? Reporter = null);
